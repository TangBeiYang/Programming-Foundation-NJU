...
void menu_upgrade(GameState& state)
{
	...
	cout << state.upgrade_state() << endl;
	cout << "--------------------------------" << endl;
	cout << "1.[100金币]自动产肉机(肉的库存不会再降至0)" << endl;
	cout << "2.[200金币]金盘子(提升卷饼价值)" << endl;
	cout << "3.[300金币]扩展区域(敬请期待)" << endl;
	cout << "0.返回主菜单" << endl;
	cout << "--------------------------------" << endl;
	cout << "请输入数字（0-3）";
}
...
void menu_start_day(GameState& state, Customer& cus)
{
	...
	cout << "卷饼20金币/个  可乐10金币/杯  薯条6金币/份" << endl;
	cout << "--------------------------------" << endl;
	cout << "提示: " << cus.name << "来了！" << endl;
	cout << "--------------------------------" << endl;
	cout << "顾客订单 (耐心: " << cus.patience << "s):" << endl;
